*** This is the code for doing the baselinse HLT decomposition, using Sample 1 (All available CPS periods).*** 
...
save "Data\Temp\HLT_results_sample1_UnCr.dta", replace
...
save "Data\Temp\HLT_results_sample1_Cr.dta", replace
