*** This is the code for doing the baselinse HLT decomposition, using Sample 3 (CPS that overlaps with the US Census).*** 
...
// Do year - 1968 instead since the intevals between years are not constant. 1969 to be 1.
