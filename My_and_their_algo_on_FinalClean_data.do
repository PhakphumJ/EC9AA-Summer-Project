*** This is the code for doing the baselinse HLT decomposition  on the dataset cleaned in the way exactly like Fang and Qiu (2023). Also run thier algorithm on this dataset.
...
save "Data\Temp\HLT_results_FinalClean.dta", replace
...
save "Data\Temp\HLT_results_identical_algo_FinalClean.dta", replace
