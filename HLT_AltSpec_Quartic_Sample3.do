*** This is the code for doing the decomposition using the alternative specification *** Implement through the iterative algorithm used for the baseline specification. ** Quartic polynomials; Sample 3.
...
save "Data\Temp\HLT_results_sample3_UnCr_AltSpec_quartic.dta", replace
...
save "Data\Temp\HLT_results_sample3_Cr_AltSpec_quartic.dta", replace
