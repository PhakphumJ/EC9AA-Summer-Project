...
use "Data\Temp\HLT_results_identical_algo_Initial.dta"
keep profile_wexp plot_wexp profile_coh plot_coh profile_year plot_year
foreach var of varlist profile_wexp profile_coh profile_year {
    rename `var' `var'_self_data_orig_algo
}
save "Data\Temp\HLT_results_self_data_orig_algo_profile.dta", replace
clear


use "Data\Temp\HLT_results_Initial.dta"
keep profile_wexp plot_wexp profile_coh plot_coh profile_year plot_year
foreach var of varlist profile_wexp profile_coh profile_year {
    rename `var' `var'_all_self
}
save "Data\Temp\HLT_results_all_self_profile.dta", replace
clear


* Merging 
use "Data\Temp\HLT_results_all_orig_profile.dta"
merge 1:1 plot_year using "Data\Temp\HLT_results_self_data_orig_algo_profile.dta", keepusing(profile_wexp* profile_coh* profile_year*) nogenerate 
merge 1:1 plot_year using "Data\Temp\HLT_results_all_self_profile.dta", keepusing(profile_wexp* profile_coh* profile_year*) nogenerate 
...
** Exporting the graph
graph export "Figs\exp_fig4_three_outputs_Init.jpg", name(exp) replace
graph export "Figs\coh_fig4_three_outputs_Init.jpg", name(coh) replace
