*** This is the code for doing the baselinse HLT decomposition  on the dataset clean with the initial way (wrong way to create outlier flag, 1 is subtracted from both age and year) 
